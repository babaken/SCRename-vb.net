...
Module SCRename
	Sub Main(ByVal CmdArgs() As String)
		...
		Dim i As Object, j As Object, k As Object, l As Object, argc As Object, opt As Object, elen As Object, days As Object, pos As Object, serv As Object
		...
		Do While (opt And 32) = 0
			...
			If InStr((Mid(str1, ii, j - ii).ToUpper()), (title).ToUpper()) > 0 Then
				...
				If j = -1 Then
					...
					Else
						If eddt Is Nothing Or Math.Abs(CType(CType((tgtdt - dt2), TimeSpan).Days, SByte)) < Math.Abs(CType(CType((tgtdt - eddt), TimeSpan).Days, SByte)) Then
							stdt = dt1
							eddt = dt2
							pos = i
						End If
